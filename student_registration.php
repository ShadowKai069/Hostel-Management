...
document.addEventListener("DOMContentLoaded", function () {
    ...
    fetch("get_rooms_details.php")
        ...
        .then(data => {
            data.forEach(room => {
                ...
                option.setAttribute("data-fees", room.fees_per_bed); // Store price in attribute
                roomSelect.appendChild(option);
            });
        })
        .catch(error => console.error("Error fetching rooms:", error));

    // Fetch beds and update room price when a room is selected
    roomSelect.addEventListener("change", function () {
        let selectedRoom = roomSelect.value;
        let selectedOption = roomSelect.options[roomSelect.selectedIndex];

        // Fetch room price from the "data-fees" attribute
        let fees_per_bed = selectedOption.getAttribute("data-fees");

        if (fees_per_bed) {
            feesInput.value = fees_per_bed; // Display the price in Fees Per Month
        } else {
            feesInput.value = ""; // Clear if no valid room selected
        }
    ...
    // Event listeners for calculating total fees
...
<div class="container2">
  ...
  <label for="room-no" required data-aos="zoom-in">Room No.:<span style="color:red">*</span></label>
...
<!-- Bed Number Dropdown -->
<label for="bed-no" required data-aos="zoom-in">Bed No.:<span style="color:red">*</span></label>
<select id="bed-no" name="bed_no">
  ...
  <!-- Fees Per Month -->
  <label for="fees">Fees Per Month:<span style="color:red">*</span></label>
  <input type="text" id="fees" name="fees" placeholder="Enter monthly fee" readonly required data-aos="zoom-in">

  <br><br>

  <!-- Stay From Date -->
  <label for="stay-from">Stay From:<span style="color:red">*</span></label>
  ...
  <select id="duration" name="duration" require>
...
<h3 style="color: green;">Personal Info</h3>
    ...
    <h4 data-aos="fade-left"><span style="color: blue;">Student Registration</span></h4>
        ...
        <div class="mb-3">
            <label for="token_no" class="form-label" data-aos="fade-up">Token No:<span style="color:red">*</span></label>
            <input type="text" id="token_no" name="token_no" required data-aos="zoom-in">
        </div>

        <div class="mb-3">
            <label for="first_name" class="form-label" data-aos="fade-up">First Name:<span style="color:red">*</span></label>
        ...
        <div class="mb-3">
            <label for="last_name" class="form-label" data-aos="fade-up">Last Name:<span style="color:red">*</span></label>
            <input type="text" class="form-control" id="last_name" name="last-name"  placeholder="Enter Last Name" required data-aos="zoom-in">
        </div>

        <div class="mb-3">
            <label for="gender" class="form-label" data-aos="fade-up">Gender:<span style="color:red">*</span></label>
        ...
        <div class="mb-3">
            <label for="contactNo" class="form-label" data-aos="fade-up">Contact No:<span style="color:red">*</span></label>
...
<span id="email-error" style="color: red;"></span>
          ...
          <div class="mb-3">
              <label for="studentaddress" class="form-label">Address:<span style="color:red">*</span></label>
              <textarea class="form-control" id="studentaddress" rows="2" name="studentaddress" required data-aos="zoom-in"></textarea>
          </div>
          <div class="mb-3">
              <label for="corrCity" class="form-label">City:<span style="color:red">*</span></label>
              <input type="text" class="form-control" id="corrCity" name="corrCity" required data-aos="zoom-in">
          </div>
          <div class="mb-3">
              <label for="corrState" class="form-label">State:<span style="color:red">*</span></label>
          ...
          <div class="mb-3">
              <label for="corrPincode" class="form-label" required data-aos="zoom-in">Pincode:<span style="color:red">*</span></label>
          ...
          <label for="student-photo">Upload Student Photo (JPEG, PNG):<span style="color:red">*</span></label>
          ...
          <label for="aadhaar-photo">Upload Aadhaar Card Photo (JPEG, PNG, PDF):<span style="color:red">*</span></label>
...
<h4 data-aos="fade-left"><span style="color: blue;">Parent/Guardian Registration</span></h4>
        <label for="parent-name" data-aos="fade-up">Parent/Guardian Name:<span style="color:red">*</span></label>
        <input type="text" id="parent-name" name="parent-name" required data-aos="zoom-in">

        <label for="parent-contact" data-aos="fade-up">Parent Contact:<span style="color:red">*</span></label>
        <input type="tel" id="parent-contact" name="parent-contact" required data-aos="zoom-in">

        <label for="parent-address" data-aos="fade-up">Address:<span style="color:red">*</span></label>
        ...
        <!-- Student Photo Upload -->
        <label for="student-photo">Upload Parent Photo (JPEG, PNG):<span style="color:red">*</span></label>
        <input type="file" id="student-photo" name="student-photo" accept="image/jpeg, image/png" required data-aos="zoom-in">
    
        <br><br>
    
        <!-- Aadhaar Card Photo Upload -->
        <label for="parent-aadhaar-photo">Upload Parent Aadhaar Card (JPEG, PNG, PDF):<span style="color:red">*</span></label>
